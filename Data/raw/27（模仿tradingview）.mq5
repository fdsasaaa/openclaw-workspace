...
input double   质量评分阈值          = 20.0;   // 合格评分阈值 (TradingView默认20)
input int      ATR周期               = 14;     // ATR周期 (TradingView默认14)
input double   ATR止损倍数           = 2.0;    // ATR止损倍数 (TradingView默认2.0)
...
input bool     启用智能过滤         = true;
input double   最小成交量倍数       = 0.8;    // 最小成交量倍数 (TradingView默认0.8)
